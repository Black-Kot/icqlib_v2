...
// -----------------------------------------------------------------------------
//
// File name      : $URL: http://172.18.13.13/svn/icqjplus/branches/0.5_branch/icq_constants.h $
// Revision       : $Revision: 308 $
// Last change on : $Date: 2009-08-26 16:47:27 +0300 (Ð¡Ñ€, 26 Ð°Ð²Ð³ 2009) $
...
#define ISI_SEND_TZER               5
#define ISI_ALWAYS_VISIBLE          6
#define ISI_NEVER_VISIBLE           7
#define ISI_INCOGNITO_REQUEST       8
#define ISI_SCAN                    9
#define ISI_SCAN_START              10
#define ISI_SCAN_STOP               11
#define ISI_SCAN_PAUSE              12
#define ISI_HIDDEN                  13
#define ISI_MANAGE_SERVER_LIST      14
#define ISI_ADVANCED_FEATURES       15
#define ISI_DISABLED_ITEM           16
#define ISI_ENABLED_ITEM            17
#define ISI_DIRECT_CONNECT          18
#define ISI_SERVER_IGNORE			19
...
#define ICMI_SEND_TZER              5
#define ICMI_ALWAYS_VISIBLE         6
#define ICMI_NEVER_VISIBLE          7
#define ICMI_INCOGNITO_REQUEST      8
#define ICMI_SCAN                   9
#define ICMI_SERVER_IGNORE			10
...
#define DEFAULT_HTTP_AGENT          "Mozilla/4.08 [en] (WinNT; U ;Nav)"
...
#define DEFAULT_KILLUNKNOWN_ENABLED 1

#define DEFAULT_SLOWSEND            1
#define DEFAULT_ONLYSERVERACKS      0

// ICQ Plus Mod Defaults ////////////

#define XSTATUS_COUNT_EXTRA 37
...
#else
#define DEFAULT_FP1                 0x0fffffff        // ANSI flag
#endif
#define DEFAULT_FP2                 ICQ_PLUG_VERSION  // version dword
#define DEFAULT_FP3                 0x00000000        // reserved for Secure IM

#define DEFAULT_CLIENT_ID                     0
#define DEFAULT_MOD_ID                        4
#define DEFAULT_HIDE_REAL_ID                  0
#define DEFAULT_PROTO_VERSION_USE_OWN         0
#define DEFAULT_USE_CUSTOM_CAPS               0
#define DEFAULT_USE_CUSTOM_PROTO_VERSION      0
#define DEFAULT_USE_SERVER_AUTOCHANGE         0

#define DEFAULT_INCOGNITO_REQUEST             0
#define DEFAULT_INCOGNITO_GLOBAL              0
#define DEFAULT_NO_STATUS_REPLY               0
#define DEFAULT_TZERS_ENABLED                 0
#define DEFAULT_CUSTOM_PROTO_VERSION_ENABLED  0
...
#define DEFAULT_NO_ASD_IN_INVISIBLE           1
#define DEFAULT_ASD_ON_STARTUP                0
#define DEFAULT_ASD_FOR_OFFLINE               1
#define DEFAULT_NO_PSD_FOR_HIDDEN             0
#define DEFAULT_DETECT_VIA_STATUS_MESSAGE     0
#define DEFAULT_DETECT_VIA_XTRAZ              0
#define DEFAULT_DETECT_VIA_URL                0
#define DEFAULT_DETECT_UNAUTHORIZED           0
#define DEFAULT_DETECT_VIA_AUTH               0
#define DEFAULT_STATUS_CHECK_SPEED            3000

#define DEFAULT_VISIBILITY_MODE               0
#define DEFAULT_PRIVACY_ENABLED               1
#define DEFAULT_WEB_AWARE                     0

#define DEFAULT_ADD_TEMP_CONTACTS             0
#define DEFAULT_ADD_TEMPORARILY_ONLY          1
#define DEFAULT_REMOVE_TEMP_ON_STARTUP        1
#define DEFAULT_TMP_SEND_YOU_WERE_ADDED       0
#define DEFAULT_TMP_REQUIRE_AUTHORIZATION     0

#define DEFAULT_SERVER_AUTOCHANGE             0

#define DEFAULT_SHOW_UIN_IN_POPUPS            0
#define DEFAULT_SHOW_FOR_NOTONLIST_ENABLED    0
#define DEFAULT_SHOW_FOR_IGNORED_ENABLED      0
#define DEFAULT_SHOW_FOR_HIDDEN_ENABLED       0

#define DEFAULT_SELFREMOVE_LOG_TO_FILE        0
#define DEFAULT_IGNORECHECK_LOG_TO_FILE       0
#define DEFAULT_STATUSCHECK_LOG_TO_FILE       0
#define DEFAULT_CLIENTCHANGE_LOG_TO_FILE      0
#define DEFAULT_AUTH_LOG_TO_FILE              0
#define DEFAULT_INFOREQUEST_LOG_TO_FILE       0
#define DEFAULT_ASD_LOG_TO_FILE               0
#define DEFAULT_SELFREMOVE_LOG_TO_HISTORY     0
#define DEFAULT_IGNORECHECK_LOG_TO_HISTORY    0
#define DEFAULT_STATUSCHECK_LOG_TO_HISTORY    0
#define DEFAULT_CLIENTCHANGE_LOG_TO_HISTORY   0
#define DEFAULT_AUTH_LOG_TO_HISTORY           0
#define DEFAULT_INFOREQUEST_LOG_TO_HISTORY    0
#define DEFAULT_ASD_LOG_TO_HISTORY            0
#define DEFAULT_LOG_TO_CONTACTS_HISTORY       0
...
#define DEFAULT_UNKNOWN_TEXT_COLORS         RGB(0,0,0)
#define DEFAULT_UNKNOWN_BACK_COLORS         RGB(255,255,255)
#define DEFAULT_UNKNOWN_TIMEOUT             0
#define DEFAULT_UNKNOWN_POPUPS_ENABLED      1
#define DEFAULT_VISIBILITY_TEXT_COLORS      RGB(0,0,0)
#define DEFAULT_VISIBILITY_BACK_COLORS      RGB(255,255,255)
#define DEFAULT_VISIBILITY_TIMEOUT          0
#define DEFAULT_VISIBILITY_POPUPS_ENABLED   1
#define DEFAULT_INFOREQUEST_TEXT_COLORS     RGB(0,0,0)
#define DEFAULT_INFOREQUEST_BACK_COLORS     RGB(255,255,255)
#define DEFAULT_INFOREQUEST_TIMEOUT         0
#define DEFAULT_INFOREQUEST_POPUPS_ENABLED  1
#define DEFAULT_CLIENTCHANGE_TEXT_COLORS    RGB(0,0,0)
#define DEFAULT_CLIENTCHANGE_BACK_COLORS    RGB(255,255,255)
#define DEFAULT_CLIENTCHANGE_TIMEOUT        0
#define DEFAULT_CLIENTCHANGE_POPUPS_ENABLED 1
#define DEFAULT_IGNORECHECK_TEXT_COLORS     RGB(0,0,0)
#define DEFAULT_IGNORECHECK_BACK_COLORS     RGB(255,255,255)
#define DEFAULT_IGNORECHECK_TIMEOUT         0
#define DEFAULT_IGNORECHECK_POPUPS_ENABLED  1
#define DEFAULT_SELFREMOVE_TEXT_COLORS      RGB(0,0,0)
#define DEFAULT_SELFREMOVE_BACK_COLORS      RGB(255,255,255)
#define DEFAULT_SELFREMOVE_TIMEOUT          0
#define DEFAULT_SELFREMOVE_POPUPS_ENABLED   1
#define DEFAULT_AUTH_TEXT_COLORS            RGB(0,0,0)
#define DEFAULT_AUTH_BACK_COLORS            RGB(255,255,255)
#define DEFAULT_AUTH_TIMEOUT                0
#define DEFAULT_AUTH_POPUPS_ENABLED         1
#define DEFAULT_XUPDATER_TEXT_COLORS        RGB(0,0,0)
#define DEFAULT_XUPDATER_BACK_COLORS        RGB(255,255,255)
#define DEFAULT_XUPDATER_TIMEOUT            0
#define DEFAULT_XUPDATER_POPUPS_ENABLED     1
#define DEFAULT_FOUND_TEXT_COLORS           RGB(0,0,0)
#define DEFAULT_FOUND_BACK_COLORS           RGB(255,255,255)
#define DEFAULT_FOUND_TIMEOUT               0
#define DEFAULT_FOUND_POPUPS_ENABLED        1
#define DEFAULT_SCAN_TEXT_COLORS            RGB(0,0,0)
#define DEFAULT_SCAN_BACK_COLORS            RGB(255,255,255)
#define DEFAULT_SCAN_TIMEOUT                0
#define DEFAULT_SCAN_POPUPS_ENABLED         1
#define DEFAULT_POPUPS_WIN_COLORS   0

#define DEFAULT_SHOW_UIN_IN_POPUP           0
#define DEFAULT_SHOW_POPUP_FOR_HIDDEN       0
#define DEFAULT_SHOW_POPUP_FOR_IGNORED      0
#define DEFAULT_SHOW_POPUP_FOR_NOTONLIST    0
...
//
#define CAPF_PUSH2TALK              0x00000200
#define CAPF_ICQ_LITE               0x00000800
#define CAPF_ICQ_DEVIL              0x00001000
#define CAPF_VOICE_CHAT             0x00002000
#define CAPF_XTRAZ_CHAT             0x00004000
#define CAPF_WAS_FOUND              0x00008000
...
#define SSI_TLV_IGNORE_TIMESTAMP	0x0145  // Ignoring timestamp
...
//define CLIENT_ID_STRING            "ICQBasic"  // Client identification, mimic ICQ 5.1
//define CLIENT_ID_CODE              0x010a
//define CLIENT_VERSION_MAJOR        0x0014
//define CLIENT_VERSION_MINOR        0x0034
//define CLIENT_VERSION_LESSER       0x0000
